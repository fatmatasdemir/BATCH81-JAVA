...
public class C05_MethodCreationReturn {
    public static void main(String[] args) {
        /* Eger bir classin icerisinde herhangi bir
         hesaplama yapip bunu da kalici olarak saklamak istersek kodumuzu
         sade ve anlasilir tutmak icin isemi bir methoda yapip sonucunu main methoda dondurebiliriz
         Return type void olmayan bir methodun sonucunu
         main methodda bir variable atama yaparsak
        ...
        // kullanicidan sehir ismini ve dogum tarihiini alip
        ...
        System.out.println("Girdiginz tarih:" + tarih);
