...
public class C04_DoWhileLoop {
    public static void main(String[] args) {
        ...
        */
        ...
        /*
        Looplarda kullanacagimiz  variable'leri loop'tan once olusturmaliyiz
        ...
        // do whike loop'da onceden olusturulan variable  hangi deger atandiginin
        // hicbir onemi yok, kodumuz her durumda calisir

        /*
        do-while dez avantaji :
        ilk calistirma kontol yapilmadan oldugu icin
