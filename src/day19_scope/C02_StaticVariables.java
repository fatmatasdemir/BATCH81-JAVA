...
public class C02_StaticVariables {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /*
         instance bir variable'in degerini bulmak icin
         objenin olusturulmasindan itibaren
    ...
    public void staticOlmayanMethod(){
        ...
        static olsun veya olmasin tum method'lar static variable'lari
        gorebilir ve degistirebilirler
        farkli method'larda static variable'in
        hangi degeri alacagini bilmek istiyorsak
        class'in basindan itibaren kodun calismasini takip etmeliyiz
        method ne zaman cagrilirsa o anki static
        variable degerini method'da kullanabiliriz
         */
        System.out.println(staticSayi); // 12
        staticSayi=20;
    }
