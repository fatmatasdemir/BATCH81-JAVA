...
public class C03_ClassVariables {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         deger atamazsak Java bu variable'lara default
        ...
        /*
        Farkli bir class'dan C02 clasindan method ve
        variable'lari kullandigimda
        C02 class'inin tamami degil sadece
