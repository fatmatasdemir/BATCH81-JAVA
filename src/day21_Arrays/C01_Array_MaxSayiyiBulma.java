...
public class C01_Array_MaxSayiyiBulma {
    ...
    public static void main(String[] args) {
      ...
      //  Soru 1- Verilen bir int array’deki en buyuk
        //  sayiyi yazdiran bir method olusturun
    ...
    public static void maxSayiyiYazdir(int[] sayilar) {
        ...
        int maxSayi=sayilar[0];// buradaki sifir rakam degil sayilarin
                            // birinci index yani 0 birinci
        // index oluyor 3 yani
