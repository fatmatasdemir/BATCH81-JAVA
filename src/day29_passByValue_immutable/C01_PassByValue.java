...
public class C01_PassByValue {
    ...
    public static void main(String[] args) {
        ...
        // 2.calisinca main method'un icinde diger method calistiktan sonra : [5, 10, 8, 27]
    }
    public static void elemanDegistir(int[] arr) {
        Random rnd=new Random();
        arr[1]=rnd.nextInt(100);
        arr[3]=rnd.nextInt(100);
        System.out.println("Method'un icinde : " + Arrays.toString(arr)); // [5, 29, 8, 13] ilk yazdirdiginda
                           // 2.calisinca Method'un icinde : [5, 10, 8, 27]
    }
