...
public class C01_OlusturmaYontemleri {
  ...
  // hafiza kullanma ,alan planlama icin bu onemli
        /*
          StringBuilder sb1=new StringBuilder(); ------lengt 0 kapasite 16
        lenght te icindeki sayi kadar yazar bosluklar dahil
        kapasite ise 16 ya ekler

        StringBuilder sb2=new StringBuilder("Java Candir...");   --lengt 14
        kapasite 16+14=30
        ...
        StringBuilder sb2=new StringBuilder("Java Candir..."); //---->Java Candir yazdirdi ---> sb2 length 11 cap 27
